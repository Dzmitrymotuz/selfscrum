...
// const Gemini = ({message, goalData}) => {
//     const [text, setText] = useState('Click "Run" to get our summary of your mood!')
//     const [loading, setLoading] = useState(false)

//      async function run(message, goalData) {
//         setLoading(!loading)
//         const API_KEY = import.meta.env.VITE_API_AI_KEY;
//         const genAI = new GoogleGenerativeAI(API_KEY);
//         const model = genAI.getGenerativeModel({ model: "gemini-pro"});
//         const prompt = `Here is a mood of a person for a time priod, in percent. 
//         Analyze it briefly and give some summary. 
//         Use no more 10 sentences in respond. 
//         Adress person as 'You'.
//         Give some advices on how to improve person's mood only if their mood is bad most of the time.
...
//         Add some analyzis on the amount of done/undone goals here (show some numbers) ${JSON.stringify(goalData)}
//         Give 1-2 advices on how to be more productive as well`
